     ...
     .then(() =>  window.scrollTo(0, 0))
      ...
      return(
        ...
        <form onSubmit={createReservation}>
            <div>
            <p>This Fall we are gathering in Tovaangar, so called Los Angeles, from November 21-25th with classes, activities and workshops planned for the 22nd- 24th.</p> 
